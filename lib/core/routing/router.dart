...
import 'package:auto_forward_sms/ui/view/home_view/from_who_view.dart';
import 'package:auto_forward_sms/ui/view/home_view/general_settings_view.dart';
import 'package:auto_forward_sms/ui/view/home_view/history_view.dart';
import 'package:auto_forward_sms/ui/view/home_view/text_rules_view.dart';
...
import 'package:auto_forward_sms/ui/view/on_boarding/login_view.dart';
import 'package:auto_forward_sms/ui/view/on_boarding/on_boarding.dart';
import 'package:auto_forward_sms/ui/view/on_boarding/register_view.dart';
...
import '../../ui/view/home_view/where_to_send_view.dart';

class PageRouter {
  static Route<dynamic> generateRoutes(RouteSettings settings) {
    return MaterialPageRoute(builder: (context) {
      final isOnline = Provider
          .of<ConnectivityProvider>(context)
          .isOnline;
      if (isOnline == false) {
